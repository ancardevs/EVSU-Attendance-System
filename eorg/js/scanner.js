    ...
    _scan() {
        ...
        if (result) {
            setTimeout(() => {
                this
                    ._emitter
                    .emit('scan', result.content, result.image || null);
            }, 0);
        }
    }
}
...
class Analyzer {
    constructor(video) {
        ...
        this.decodeCallback = ZXing
            .Runtime
            .addFunction(function (ptr, len, resultIndex, resultCount) {
    ...
    analyze() {
        ...
        let data = this
            .canvasContext
            .getImageData(0, 0, this.sensorWidth, this.sensorHeight)
            .data;
...
class Scanner extends EventEmitter {
    constructor(opts) {
        ...
        let refractoryPeriod = opts.refractoryPeriod || (3 * 1000);
