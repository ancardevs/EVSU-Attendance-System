...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      if(mysqli_num_rows($checkifstudentresult) == 1)
      {
        ...
        $check_if_respondent_all  = "SELECT tr.event_no AS eno, tr.course_code AS ccode, tr.course_year AS cyear FROM tbl_respondent AS tr WHERE tr.course_code = 'All' AND tr.course_year = 'All' ";
